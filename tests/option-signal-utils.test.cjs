...
test('archived PA signal never creates an order intent', () => {
  const signal = parseOptionSignal({
    id: 'archive-1', channel_id: 'c1', embeds: [{
      title: 'AAPL 2026-07-17 200C | PA',
      fields: [
        { name: FIELD.executionView, value: '鏂瑰悜锛氬亸澶氾紝浜ゆ槗' },
        { name: FIELD.executionPlan, value: '鍏ュ満 100 鐩爣 150 姝㈡崯 90' },
        { name: FIELD.invalidation, value: '鑳滅巼 65%' },
      ],
    }],
  }, 'REST_ARCHIVE');
  signal.live_eligible = false;
