...
const protoRoot = require("./proto.cjs");
protobuf.util.Long = long;
protobuf.configure();

export const mmCmdID = {
    // 全局协议
	...
	TrdGetOrderFee: { cmd: 2225, name: 'Trd_GetOrderFee', description: '获取订单收费明细数据' }, /**< 获取订单收费明细数据 */
	TrdFlowSummary: { cmd: 2226, name: 'Trd_FlowSummary', description: '获取资金流水' }, /**< 获取资金流水 */
}
...
class mmWebsocket {
    ...
    static findCmdObj(cmd) {
        for (let key in mmCmdID) {
            if (mmCmdID[key].cmd == cmd) {
                return mmCmdID[key];
            }
        }
        return null;
    ...
    start(ip, port, ssl, key) {
        if (this.websock == null || this.websock == undefined) {
            this.websock = new mmWebsocketBase()
	...
	*/
    Sub(req) {
        return this._sendCmd(mmCmdID.QotSub.cmd, req, mmCmdID.QotSub.name);
    }
    /**
     * @brief 获取交易帐号列表
     ...
     */
    GetAccList(req) {
        return this._sendCmd(mmCmdID.TrdGetAccList.cmd, req, mmCmdID.TrdGetAccList.name);
    }
	/**
	...
	*/
    UnlockTrade(req) {
        return this._sendCmd(mmCmdID.TrdUnlockTrade.cmd, req, mmCmdID.TrdUnlockTrade.name);
    }
	/**
	* @brief 订阅接收推送数据的交易账户
	...
	*/
    SubAccPush(req) {
        return this._sendCmd(mmCmdID.TrdSubAccPush.cmd, req, mmCmdID.TrdSubAccPush.name);
    }
	/**
	* @brief 获取账户资金
	...
	*/
    GetFunds(req) {
        return this._sendCmd(mmCmdID.TrdGetFunds.cmd, req, mmCmdID.TrdGetFunds.name);
    }
	/**
	* @brief 获取账户持仓
	...
	*/
    GetPositionList(req) {
        return this._sendCmd(mmCmdID.TrdGetPositionList.cmd, req, mmCmdID.TrdGetPositionList.name);
    }
	/**
	* @brief 获取最大交易数量
	...
	*/
    GetMaxTrdQtys(req) {
        return this._sendCmd(mmCmdID.TrdGetMaxTrdQtys.cmd, req, mmCmdID.TrdGetMaxTrdQtys.name);
    }
	/**
	* @brief 获取当日订单列表
	...
	*/
    GetOrderList(req) {
        return this._sendCmd(mmCmdID.TrdGetOrderList.cmd, req, mmCmdID.TrdGetOrderList.name);
    }
	/**
	* @brief 下单
	...
	*/
    PlaceOrder(req) {
        return this._sendCmd(mmCmdID.TrdPlaceOrder.cmd, req, mmCmdID.TrdPlaceOrder.name);
    }
	/**
	* @brief 修改订单
	...
	*/
    ModifyOrder(req) {
        return this._sendCmd(mmCmdID.TrdModifyOrder.cmd, req, mmCmdID.TrdModifyOrder.name);
    }
	/**
	* @brief 获取当日成交列表
	...
	*/
    GetOrderFillList(req) {
        return this._sendCmd(mmCmdID.TrdGetOrderFillList.cmd, req, mmCmdID.TrdGetOrderFillList.name);
    }
	/**
	* @brief 获取历史订单列表
	...
	*/
    GetHistoryOrderList(req) {
        return this._sendCmd(mmCmdID.TrdGetHistoryOrderList.cmd, req, mmCmdID.TrdGetHistoryOrderList.name);
    }
	/**
	* @brief 获取历史成交列表
	...
	*/
    GetHistoryOrderFillList(req) {
        return this._sendCmd(mmCmdID.TrdGetHistoryOrderFillList.cmd, req, mmCmdID.TrdGetHistoryOrderFillList.name);
    }
	/**
	* @brief 获取融资融券数据
	...
	*/
    GetMarginRatio(req) {
        return this._sendCmd(mmCmdID.TrdGetMarginRatio.cmd, req, mmCmdID.TrdGetMarginRatio.name);
    }
	...
	*/
    GetOrderFee(req) {
        return this._sendCmd(mmCmdID.TrdGetOrderFee.cmd, req, mmCmdID.TrdGetOrderFee.name);
    }
	
	/**
	* @brief 获取资金流水
	* @param [in] stReq 请求包，具体字段请参考Trd_FlowSummary.proto协议
	*/
    GetFlowSummary(req) {
        return this._sendCmd(mmCmdID.TrdFlowSummary.cmd, req, mmCmdID.TrdFlowSummary.name);
    }
	...
	*/
    GetGlobalState(req) {
        return this._sendCmd(mmCmdID.GetGlobalState.cmd, req, mmCmdID.GetGlobalState.name);
    }
	/**
	* @brief 注册推送
	...
	*/
    RegQotPush(req) {
        return this._sendCmd(mmCmdID.QotRegQotPush.cmd, req, mmCmdID.QotRegQotPush.name);
    }
	/**
	* @brief 获取订阅信息
	...
	*/
    GetSubInfo(req) {
        return this._sendCmd(mmCmdID.QotGetSubInfo.cmd, req, mmCmdID.QotGetSubInfo.name);
    }
	/**
	* @brief 获取逐笔
	...
	*/
    GetTicker(req) {
        return this._sendCmd(mmCmdID.QotGetTicker.cmd, req, mmCmdID.QotGetTicker.name);
    }
	/**
	* @brief 获取报价
	...
	*/
    GetBasicQot(req) {
        return this._sendCmd(mmCmdID.QotGetBasicQot.cmd, req, mmCmdID.QotGetBasicQot.name);
    }
	/**
	* @brief 获取摆盘
	...
	*/
    GetOrderBook(req) {
        return this._sendCmd(mmCmdID.QotGetOrderBook.cmd, req, mmCmdID.QotGetOrderBook.name);
    }
	/**
	* @brief 获取K线
	...
	*/
    GetKL(req) {
        return this._sendCmd(mmCmdID.QotGetKL.cmd, req, mmCmdID.QotGetKL.name);
    }
	/**
	* @brief 获取分时
	...
	*/
    GetRT(req) {
        return this._sendCmd(mmCmdID.QotGetRT.cmd, req, mmCmdID.QotGetRT.name);
    }
	/**
	* @brief 获取经纪队列
	...
	*/
    GetBroker(req) {
        return this._sendCmd(mmCmdID.QotGetBroker.cmd, req, mmCmdID.QotGetBroker.name);
    }
	/**
	...
	*/
    RequestRehab(req) {
        return this._sendCmd(mmCmdID.QotRequestRehab.cmd, req, mmCmdID.QotRequestRehab.name);
    }
	/**
	...
	*/
    RequestHistoryKL(req) {
        return this._sendCmd(mmCmdID.QotRequestHistoryKL.cmd, req, mmCmdID.QotRequestHistoryKL.name);
    }
	/**
	* @brief 获取历史K线已经用掉的额度 
	...
	*/
    RequestHistoryKLQuota(req) {
        return this._sendCmd(mmCmdID.QotRequestHistoryKLQuota.cmd, req, mmCmdID.QotRequestHistoryKLQuota.name);
    }
	/**
	* @brief 获取交易日
	...
	*/
    GetTradeDate(req) {
        return this._sendCmd(mmCmdID.QotGetTradeDate.cmd, req, mmCmdID.QotGetTradeDate.name);
    }
	/**
	* @brief 获取静态信息
	...
	*/
    GetStaticInfo(req) {
        return this._sendCmd(mmCmdID.QotGetStaticInfo.cmd, req, mmCmdID.QotGetStaticInfo.name);
    }
	/**
	* @brief 获取股票快照
	...
	*/
    GetSecuritySnapshot(req) {
        return this._sendCmd(mmCmdID.QotGetSecuritySnapshot.cmd, req, mmCmdID.QotGetSecuritySnapshot.name);
    }
	/**
	* @brief 获取板块集合下的板块
	...
	*/
    GetPlateSet(req) {
        return this._sendCmd(mmCmdID.QotGetPlateSet.cmd, req, mmCmdID.QotGetPlateSet.name);
    }
	/**
	* @brief 获取板块下的股票
	...
	*/
    GetPlateSecurity(req) {
        return this._sendCmd(mmCmdID.QotGetPlateSecurity.cmd, req, mmCmdID.QotGetPlateSecurity.name);
    }
	/**
	* @brief 获取相关股票
	...
	*/
    GetReference(req) {
        return this._sendCmd(mmCmdID.QotGetReference.cmd, req, mmCmdID.QotGetReference.name);
    }
	/**
	* @brief 获取股票所属的板块
	...
	*/
    GetOwnerPlate(req) {
        return this._sendCmd(mmCmdID.QotGetOwnerPlate.cmd, req, mmCmdID.QotGetOwnerPlate.name);
    }
	/**
	* @brief 获取大股东持股变化列表
	...
	*/
    GetHoldingChangeList(req) {
        return this._sendCmd(mmCmdID.QotGetHoldingChangeList.cmd, req, mmCmdID.QotGetHoldingChangeList.name);
    }
	/**
	* @brief 筛选期权
	...
	*/
    GetOptionChain(req) {
        return this._sendCmd(mmCmdID.QotGetOptionChain.cmd, req, mmCmdID.QotGetOptionChain.name);
    }
	/**
	* @brief 筛选窝轮
	...
	*/
    GetWarrant(req) {
        return this._sendCmd(mmCmdID.QotGetWarrant.cmd, req, mmCmdID.QotGetWarrant.name);
    }
	/**
	* @brief 获取资金流向
	...
	*/
    GetCapitalFlow(req) {
        return this._sendCmd(mmCmdID.QotGetCapitalFlow.cmd, req, mmCmdID.QotGetCapitalFlow.name);
    }
	/**
	* @brief 获取资金分布
	...
	*/
    GetCapitalDistribution(req) {
        return this._sendCmd(mmCmdID.QotGetCapitalDistribution.cmd, req, mmCmdID.QotGetCapitalDistribution.name);
    }
	/**
	* @brief 获取自选股分组下的股票
	...
	*/
    GetUserSecurity(req) {
        return this._sendCmd(mmCmdID.QotGetUserSecurity.cmd, req, mmCmdID.QotGetUserSecurity.name);
    }
	/**
	* @brief 修改自选股分组下的股票
	...
	*/
    ModifyUserSecurity(req) {
        return this._sendCmd(mmCmdID.QotModifyUserSecurity.cmd, req, mmCmdID.QotModifyUserSecurity.name);
    }
	/**
	* @brief 条件选股
	...
	*/
    StockFilter(req) {
        return this._sendCmd(mmCmdID.QotStockFilter.cmd, req, mmCmdID.QotStockFilter.name);
    }
	/**
	* @brief 获取股票代码变化信息
	...
	*/
    GetCodeChange(req) {
        return this._sendCmd(mmCmdID.QotGetCodeChange.cmd, req, mmCmdID.QotGetCodeChange.name);
    }
	/**
	* @brief 新股IPO
	...
	*/
    GetIpoList(req) {
        return this._sendCmd(mmCmdID.QotGetIpoList.cmd, req, mmCmdID.QotGetIpoList.name);
    }
    /**
	* @brief 期货合约资料
	...
	*/
    GetFutureInfo(req) {
        return this._sendCmd(mmCmdID.QotGetFutureInfo.cmd, req, mmCmdID.QotGetFutureInfo.name);
    }
    /**
	* @brief 获取市场交易日
	...
	*/
    RequestTradeDate(req) {
        return this._sendCmd(mmCmdID.QotRequestTradeDate.cmd, req, mmCmdID.QotRequestTradeDate.name);
    }
	/**
	* @brief 设置到价提醒
	...
	*/
    SetPriceReminder(req) {
        return this._sendCmd(mmCmdID.QotSetPriceReminder.cmd, req, mmCmdID.QotSetPriceReminder.name);
    }
	/**
	* @brief 获取到价提醒
	...
	*/
    GetPriceReminder(req) {
        return this._sendCmd(mmCmdID.QotGetPriceReminder.cmd, req, mmCmdID.QotGetPriceReminder.name);
    }
	/**
	* @brief 获取自选股分组列表
	...
	*/
    GetUserSecurityGroup(req) {
        return this._sendCmd(mmCmdID.QotGetUserSecurityGroup.cmd, req, mmCmdID.QotGetUserSecurityGroup.name);
    }
    /**
	* @brief 获取股票对应市场状态
	...
	*/
    GetMarketState(req) {
        return this._sendCmd(mmCmdID.QotGetMarketState.cmd, req, mmCmdID.QotGetMarketState.name);
    }
    /**
	* @brief 获取期权链到期日
	...
	*/
    GetOptionExpirationDate(req) {
        return this._sendCmd(mmCmdID.QotGetOptionExpirationDate.cmd, req, mmCmdID.QotGetOptionExpirationDate.name);
    }
    //=============================================
    /**
	* @brief 发送数据
        ...
        if (response && response.cmd) {
            if (this.onPush && typeof this.onPush == 'function') {
                if (response.error == 0 && response.buff) {  //成功的推送
                    let obj = mmWebsocket.findCmdObj(response.cmd)
